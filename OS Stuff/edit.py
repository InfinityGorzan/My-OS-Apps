...
class TextEditor:
  def __init__(self,root):
    self.root = root
    self.root.title("INFINITYX-OSX EDITOR")
    self.root.geometry("1200x700+200+150")
    self.root.iconbitmap("edit.ico")
    self.filename = None
    ...
    self.status.set("Welcome To INFINITYX-OSX EDITOR")
  ...
  def undo(self,*args):
    try:
      ...
      messagebox.showerror("Exception",e)
  def infoabout(self):
    messagebox.showinfo("About INFINITYX-OSX EDITOR","INFINITYX-OSX EDITOR is a simple text editor included with INFINITYX-OSX")
  def shortcuts(self):
